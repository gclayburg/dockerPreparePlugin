...
[![GitHub release](https://img.shields.io/github/release/gclayburg/dockerPreparePlugin.svg)](https://plugins.gradle.org/plugin/com.garyclayburg.dockerprepare)
...
```groovy
plugins {
  id "com.garyclayburg.dockerprepare" version "1.3.3"
}
```
